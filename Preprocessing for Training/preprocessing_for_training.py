...
Original file is located at
    https://colab.research.google.com/drive/1mfLWi0OVP6LQv13XDLZPjLGwQLpTAZAk
"""
...
def replace_outliers_47sigma_with_nan_median(df):
    """
    Replace values outside ±4.7 standard deviations from the median with NaN,
    then fill with median for each column after 'diff_ax_CU'.
    """
...
# ----------------------------------------------------------------------------
# EXAMPLE USAGE (commented out; adjust paths/names as needed):
#
data = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/Prediction_for_TJ_Surgery/practice/classification/final_df.csv')
...
# Perform split
X_train_tensor, X_valid_tensor, X_test_tensor, y_train_tensor, y_valid_tensor, y_test_tensor = data_split(X_array, y_array, random_state=42)
# ----------------------------------------------------------------------------
