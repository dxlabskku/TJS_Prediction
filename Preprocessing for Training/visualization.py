...
Original file is located at
    https://colab.research.google.com/drive/1PVsKnwzlO-L_UWd2wr-9eLrQ2yKbOhdd
"""
...
def plot_performance_with_auroc(
    ...
    """
    Evaluate a trained model on test data, then visualize confusion matrix,
    classification report, ROC-AUC, predictions, and the training/validation loss curves.
    """
    model.eval()
